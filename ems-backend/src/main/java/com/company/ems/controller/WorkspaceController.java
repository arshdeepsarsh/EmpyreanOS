...
public class WorkspaceController {
    ...
    public List<Asset> getAssets(@PathVariable String employeeName) {
        return assetRepo.findByEmployeeName(employeeName);
    }

    @GetMapping("/docs/{employeeName}")
    public List<EmployeeDocument> getDocs(@PathVariable String employeeName) {
        return docRepo.findByEmployeeName(employeeName);
    }
    ...
    public void seedTestData() {
        if (assetRepo.count() == 0) {
            Asset a1 = new Asset();
            a1.setEmployeeName("Arsh");
            a1.setType("Laptop");
            a1.setModel("MacBook Pro 16\" M3 Max");
            a1.setSerialNumber("C02-ARSH-99X");
            a1.setAssignedDate("2024-01-10");
            a1.setStatus("Active");

            Asset a3 = new Asset();
            a3.setEmployeeName("Jason Jack");
            a3.setType("Laptop");
            a3.setModel("ThinkPad X1 Carbon");
            a3.setSerialNumber("TP-8812-ZZ");
            a3.setAssignedDate("2024-02-01");
            a3.setStatus("Active");
        ...
        if (docRepo.count() == 0) {
            ...
            d1.setEmployeeName("Arsh");
            d1.setTitle("CEO Founder Agreement");
            d1.setType("PDF");
            d1.setAddedDate("2024-01-01");

            EmployeeDocument d3 = new EmployeeDocument();
            d3.setEmployeeName("Jason Jack");
            d3.setTitle("Signed Offer Letter");
            d3.setType("PDF");
            d3.setAddedDate("2024-02-01");
